/*******************************************************************************
* timsort.c: this file is part of the CosmoGAME program.

* CosmoGAME: Cosmological GAussian Mock gEnerator.
...
*******************************************************************************/
  ...
  defined(TIMSORT_RESET) && defined(TIMSORT_CMP_IDX) && \
  defined(TIMSORT_CMP_BIND) && defined(TIMSORT_ASSIGN_IDX) && \
  defined(TIMSORT_ASSIGN_BIND) && defined(TIMSORT_GET_BIND) && \
  defined(TIMSORT_SWAP)
